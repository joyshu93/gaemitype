  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-6 sm:px-6 sm:py-10">
      ...
      <section className="mt-5 rounded-[24px] border border-ink/10 bg-white px-5 py-4 text-sm leading-6 text-ink/68 shadow-card">
        {result.mode === "answers"
          ? "내 응답을 바탕으로 정리한 결과예요. 아래 요약은 답변 흐름을 기준으로 보여드려요."
          : "공유 링크로 열어본 결과예요. 타입과 기본 성향은 볼 수 있지만, 실제 응답이 없어서 세부 강도는 표시하지 않아요."}
      </section>
      ...
      <section className="mt-5 rounded-[28px] border border-ink/10 bg-white p-6 shadow-card">
        ...
        <p className="mt-3 text-sm leading-7 text-ink/68">
          이 결과는 사용자의 투자 습관과 판단 성향을 가볍게 돌아보는
          참고용 요약이에요. 종목 추천, 수익 보장, 맞춤형 투자 제안,
          매수나 매도 신호를 제공하지 않아요.
        </p>
